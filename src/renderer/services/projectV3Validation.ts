...
export function validateProjectV3Document(value: unknown): string[] {
  ...
  if (project.workbookLoadSettings !== undefined && (!isRecord(project.workbookLoadSettings)
    || Boolean(unknownKey(project.workbookLoadSettings, new Set(['parseImages', 'parseOfficeMath', 'restoreExcelActiveCell', 'performanceLogging', 'experimentalStagedLoading'])))
    || typeof project.workbookLoadSettings.parseImages !== 'boolean'
    || typeof project.workbookLoadSettings.parseOfficeMath !== 'boolean'
    || typeof project.workbookLoadSettings.restoreExcelActiveCell !== 'boolean'
